## Magento 2 Spanish Argentina Language Pack
...
![Spanish Argentina language pack process](https://progress-bar.dev//?title=completed)
...
```
composer require mageplaza/magento-2-spanish-argentina-language-pack:dev-master mageplaza/module-smtp 
